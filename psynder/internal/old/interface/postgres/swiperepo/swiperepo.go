...
//	"github.com/peltorator/psynder/internal/old/interface/postgres"
//	"github.com/peltorator/psynder/internal/old/repo"
//)
//
//type Psyna struct {
//	postgres.Model
...
//	if r.Error != nil {
//		// TODO: ???
//		return errors.New("Accounts or psyna doesn't exist")
//	}
//	return nil
//}
//
...
//	//for rows.Next() {
//	//	p := new(model.Psyna)
//	//	err = rows.Scan(&p.Uid, &p.Name, &p.Description, &p.PhotoLink)
//	//	if err != nil {
//	//		return []model.Psyna{}, err
//	//	}
